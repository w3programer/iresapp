...
//        addGesture()
//        if isSearchEnable{
////            NotificationCenter.default.addObserver(self, selector: #selector(self.keyboardWillShow(notification:)), name: UITextField.textDidChangeNotification, object: nil) { (notification) in
//            NotificationCenter.default.addObserver(forName: NSNotification.Name.UIResponder.keyboardWillShowNotification, object: nil, queue: nil) { (notification) in
...
//
//            }
//            NotificationCenter.default.addObserver(forName: NSNotification.Name.UIResponder.keyboardWillHideNotification, object: nil, queue: nil) { (notification) in
//                if self.isFirstResponder{
